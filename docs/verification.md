...
Verified locally on 2026-09-24 for v1.7.0. The Python suite
passes 273 offline tests on Python 3.11, 3.12, and 3.13. Exhaustive behavior across every provider and
